...
class Project(models.Model):
    ...
    imageA = models.ForeignKey(to=Image, related_name="imageA_project", verbose_name="imageA", on_delete=models.SET_NULL, blank=True, null=True)
    imageB = models.ForeignKey(to=Image, related_name="imageB_project", verbose_name="imageB", on_delete=models.SET_NULL, blank=True, null=True)

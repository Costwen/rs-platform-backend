...
CELERY_BROKER_URL = 'redis://:jxdhandsome@101.43.134.156:6379/0' # Broker配置，使用Redis作为消息中间件

CELERY_RESULT_BACKEND = 'redis://:jxdhandsome@101.43.134.156:6379/1' # BACKEND配置，这里使用redis
